...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 480, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 80, 70, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 150, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 150, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 400, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 480, 480, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 530, 200, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 850, 180, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 800, 300, 30, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 70, 200, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 800, 80, 30, 15, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 820, 95, 30, 15, 2),
    //new Obstaculo('imagenes/llegada.png', 760, 510, 127,75, 0)
  ],
  //LLEGADA
  ...
  enemigos: [
    ...
    new ZombieCaminante('imagenes/zombie2.png',960,200,10,10,1,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie1.png',960,300,10,10,2,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie1.png',800,0,10,10,4,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieCaminante('imagenes/zombie2.png',0,350,10,10,2,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577}),
    new ZombieConductor('imagenes/tren_vertical.png',675,0,30,90,12,{desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577},"v"),
...
Juego.dibujarMeta = function(){
  for(var i=758; i<880; (i+=20)){
    ...
    if(i<870){
      Dibujante.dibujarRectangulo("white",i+10, 545, 10,10);
    }
  }
}
...
Juego.dibujarFondo = function() {
  ...
  if (this.terminoJuego()) {
    ...
    this.jugador.sprite='imagenes/empty.png';
